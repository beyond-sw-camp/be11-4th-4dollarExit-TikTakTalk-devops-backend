...
@Qualifier("likes")
    ...
    public LikesService(PostRepository postRepository, UserRepository userRepository, LikesRabbitmqService likesRabbitmqService, @Qualifier("likes")RedisTemplate redisTemplate) {
