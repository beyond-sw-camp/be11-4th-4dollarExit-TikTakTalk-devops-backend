...
//                특정 url 패턴에 대해서는 Authentication 객체 요구하지 않음 (인증처리 제외)
                .authorizeHttpRequests(a->a.requestMatchers(
                        ...
                        ,"ttt/category/all","/connect/**", "/ttt/user/google/doLogin", "/ttt/user/kakao/doLogin", "ttt/user/oauth/create","/ttt/user/checkLoginId").permitAll().anyRequest().authenticated())
